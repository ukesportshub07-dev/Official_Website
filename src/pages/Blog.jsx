  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900 p-10 lg:pl-48 ">
        <h1 className="text-5xl font-extrabold text-white">Daily Updates</h1>
        <p className="text-blue-200 text-lg mt-2">Daily esports news, gaming updates, patch notes, tournament results, and professional guides covering BGMI, Valorant, CS2, and more.</p>
