        ...
        >
          <div className="px-4 pb-4 pt-2 space-y-2 bg-gray-800/90 text-gray-200">
            ...
            <div className="border-t border-gray-700 pt-2">
              ...
              {isBlogOpen && (
                <div className="pl-4 border-l border-[#7c3aed] ml-2 space-y-1 py-1 animate-fade-in-down">
                  <HashLink to="/updates" scroll={scrollWithOffset} className="block py-1 text-sm hover:text-[#7c3aed]" onClick={handleLinkClick}>Updates</HashLink>
                  <HashLink to="/blog" scroll={scrollWithOffset} className="block py-1 text-sm hover:text-[#7c3aed]" onClick={handleLinkClick}>Latest News</HashLink>
                </div>
              )}
            </div>
