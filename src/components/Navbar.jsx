              ...
              <div className="relative">
                ...
                {isBlogOpen && (
                  <div className="absolute right-0 mt-3 w-48 rounded-lg shadow-2xl bg-gray-700/95 backdrop-blur ring-1 ring-white/10 focus:outline-none z-50 origin-top-right animate-fade-in-down">
                    ...
                    <HashLink to="/blog#news" scroll={scrollWithOffset} className="block px-4 py-2 text-sm text-gray-200 hover:text-[#7c3aed] rounded-md mx-1 transition-colors" onClick={handleLinkClick}>Esports Updates</HashLink>
                  </div>
                )}
              </div>
