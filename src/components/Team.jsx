...
function Team() {
  ...
  return (
    <div className="py-12 bg-gray-900 min-h-screen flex flex-col justify-center font-inter">
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-extrabold text-grey-500 text-center mb-4 tracking-tight sm:text-5xl">
          Meet Our Core Team
        </h2>
        <p className="text-gray-400 mt-2 px-2 pb-4 text-center">Organizers, Admins and Members who run UK ESPORTS HUB.</p>
        ...
        >
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-4 md:pr-0 md:flex hidden">
            <button
              onClick={goToNext}
